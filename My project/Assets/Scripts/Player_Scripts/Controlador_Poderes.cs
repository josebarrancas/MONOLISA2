...
public class Controlador_Poderes : MonoBehaviour
{
    ...
    private void ActualizarIconoYCargas()
    {
        ...
        // 2. FORZAR ACTUALIZACIÓN DE LAS CARGAS DEL NUEVO PODER
    ...
    /// <summary>
    /// Escanea el script del poder actual y extrae dinámicamente sus cargasRestantes para la barra del HUD.
    /// </summary>
